  ...
  <body>
    ...
    <main>
      ...
      >
        ...
        ></a>
        <!-- <div class="hero-content d-flex flex-column p-1 p-md-5">
          ...
          <div class="container-fluid ror">
            <div class="row">
              <div class="col text-center">
                <p class="title">The Making of Agrikultur'App</p>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col">
      ...
      <section class="contact-section container-fluid" id="contact">
        <div class="contact-content">
          ...
          <div class="row row-cols-1 row-cols-lg-2">
            ...
            >
              <div
                class="contact-info shadow-lg d-flex justify-content-center align-items-center"
              >
      ...
      <!--FAQS Section-->
      <section class="faqs-section container-fluid h-auto" id="faqs">
        <p class="title">
